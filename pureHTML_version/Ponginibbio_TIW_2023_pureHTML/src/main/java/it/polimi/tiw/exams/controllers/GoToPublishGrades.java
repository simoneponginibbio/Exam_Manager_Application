...
public class GoToPublishGrades extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			registrations = registrationDAO.getStudentRegistrationsByExam(courseName, examDate, "id", "ASC");
		} catch(SQLException e) {
			forwardToErrorPage(request, response, e.getMessage());
			return;
		}
		// Gets the number of publishable registrations for the courseName exam and examDate date
		...
		// Gets the number of verbalisable registrations for the courseName exam and examDate date
